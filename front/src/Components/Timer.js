...
class Timer extends Component {
  ...
  playTimer = () => {
    ...
    document.title = `${this.state.currentSession} – ${
      this.state.currentMinutes < 10
  ...
  handleSubmit = (event) => {
    ...
    if (
      !isNaN(this.state.workLength) &&
      !isNaN(this.state.breakLength) &&
      this.state.workLength >= 1 &&
      this.state.workLength <= 60 &&
      ...
      localStorage.setItem(
        "breakTimer",
        JSON.stringify(this.state.breakLength)
      );
      this.closeModal();
      document.title = "Pomodoro Timer";
    } else {
              ...
              <div className="modal-body">
                ...
                >
                  ...
                  >
                    ...
                    Please enter numbers between 1 and 60.
                  </p>
                  {/* FORM BUTTONS */}
        ...
        <main>
          ...
          <div className="button-group timer-buttons">
            <button
              ...
              onClick={this.state.currentButton.func}
              aria-label={this.state.currentButton.title}
              title={this.state.currentButton.title}
            >
              <span
                className={`fa ${this.state.currentButton.icon} fa-lg`}
              ></span>
              Play/Stop
            </button>
            <button
